...
class FrameManager(object):
   ...
   class _FM(object):
      ...
      _FRAME_SIZES = {
         ...
         "dirt.png" : (16,16),
         "brush.png" : (32,32),
         "House1Back.png" : (80,80),
         "fountain.png" : (48,48),
         "floorInside.png" : (16,16)
      }
      ...
      _TRANSPARENCY = ["textbox.png", "fountain.png", "floorInside.png"]
      
      # A list of images that require to be loaded with a color key
      _COLOR_KEY = ["arrow.png", "halcyon.png", "npc.png", "House1.png", "dirt.png", "brush.png", "House1Back.png","door.png"]
